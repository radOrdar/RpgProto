...
namespace FlyingWormConsole3.LiteNetLib
{
    ...
    public sealed class NetPeer
    {
        ...
        public void Send(byte[] data, int start, int length, SendOptions options)
        {
            ...
            {
                if (options == SendOptions.Sequenced || options == SendOptions.Unreliable) throw new Exception("Unreliable packet size > allowed (" + (_mtu - headerSize) + ")");
                ...
                if (totalPackets > ushort.MaxValue) throw new Exception("Too many fragments: " + totalPackets + " > " + ushort.MaxValue);
