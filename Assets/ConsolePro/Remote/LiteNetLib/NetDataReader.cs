...
namespace FlyingWormConsole3.LiteNetLib.Utils
{
    public class NetDataReader
    {
        ...
        public bool[] GetBoolArray()
        {
            ...
            for (var i = 0; i < size; i++) arr[i] = GetBool();
            return arr;
        }
        ...
        public ushort[] GetUShortArray()
        {
            ...
            for (var i = 0; i < size; i++) arr[i] = GetUShort();
            return arr;
        }
        ...
        public short[] GetShortArray()
        {
            ...
            for (var i = 0; i < size; i++) arr[i] = GetShort();
            return arr;
        }
        ...
        public long[] GetLongArray()
        {
            ...
            for (var i = 0; i < size; i++) arr[i] = GetLong();
            return arr;
        }
        ...
        public ulong[] GetULongArray()
        {
            ...
            for (var i = 0; i < size; i++) arr[i] = GetULong();
            return arr;
        }
        ...
        public int[] GetIntArray()
        {
            ...
            for (var i = 0; i < size; i++) arr[i] = GetInt();
            return arr;
        }
        ...
        public uint[] GetUIntArray()
        {
            ...
            for (var i = 0; i < size; i++) arr[i] = GetUInt();
            return arr;
        }
        ...
        public float[] GetFloatArray()
        {
            ...
            for (var i = 0; i < size; i++) arr[i] = GetFloat();
            return arr;
        }
        ...
        public double[] GetDoubleArray()
        {
            ...
            for (var i = 0; i < size; i++) arr[i] = GetDouble();
            return arr;
        }
        ...
        public string[] GetStringArray(int maxLength)
        {
            ...
            for (var i = 0; i < size; i++) arr[i] = GetString(maxLength);
            return arr;
        }
